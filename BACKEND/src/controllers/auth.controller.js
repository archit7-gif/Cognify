...
// Password validation function (remains unchanged)
...
const registerUser = async(req,res)=>{
    ...
    // FIX: Normalize email to lowercase before use
    ...
    // Use the normalized email for checks and creation
